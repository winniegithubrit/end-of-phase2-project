...
setAnimals(
  data.map((animal)=>({
    ...animal,
    liked:false      //here am adding the like state to each animal
  }))))
  },[])
...
{animals.map((animal)=>{
  ...
  return (<div className="animal-card"> 
   ...
   {/* <button onClick={handleUpdate(animal)}>UPDATE</button> */}
    {/* <UpdateAnimal 
    animals={animals} setAnimals={setAnimals}
 animalToUpdate={animalToUpdate}
 setAnimalToUpdate={setAnimalToUpdate}
